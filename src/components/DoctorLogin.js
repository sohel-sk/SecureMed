  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-gray-900">
        <div className="w-full max-w-4xl bg- p-20 rounded-lg shadow-lg">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Doctor Login</h2>
          <div className="mb-4">
            <label className="block font-bold text-gray-900" htmlFor="hhNumber">
              HH Number
            </label>
            <input
              id="hhNumber"
              ...
              type="text"
              required
              className={`mt-2 p-2 w-full text-black bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200 ${hhNumberError && "border-red-500"}`}
          ...
          <div className="flex flex-col w-full mb-4">
            ...
            <input
              ...
              className="p-2 w-full text-black bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200"
              required
            />
          </div>
