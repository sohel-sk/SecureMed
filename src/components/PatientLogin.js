...
const PatientLogin = () => {
  ...
  return (
    <div>
      <NavBar />
      <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center p-4 font-mono text-gray-900">
        <div className="w-full max-w-4xl bg-gray-100 p-20 rounded-lg shadow-lg">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              type="text"
              required
              className={`mt-2 p-2 w-full text-gray-900 bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200 ${hhNumberError && "border-red-500"}`}
          ...
          <div className="flex flex-col w-full mb-4">
            ...
            <input
              ...
              className="p-2 w-full text-gray-900 bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200"
              required
            />
          </div>
