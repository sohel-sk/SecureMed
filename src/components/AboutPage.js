...
const AboutUs = () => {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="flex flex-col text-gray-900 space-y-8 w-3/5 p-8 bg-gray-100 shadow-lg rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
          <div className="space-y-4">
            <h1 className="font-mono text-lg text-center font-semibold">About Us</h1> {/* Center align the "About Us" heading */}
      ...
      <div className="flex justify-center">
        <button
          className="px-4 py-2 font-bold text-white transition duration-300 ease-in-out transform bg-teal-600 rounded hover:scale-110 hover:bg-gray-600"
          onClick={() => {
            navigate("/");
          }}
        >
