...
const PatientRegistry = () => {
  ...
  return (
    <div>
    <NavBar></NavBar>
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-100 font-mono">
      <div className="w-full max-w-4xl">
        <h2 className="text-3xl   mb-6 font-bold text-center">
         Patient Registration
        </h2>
        <form className="bg-gray-100 p-6 rounded-lg shadow-lg grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-4">
            <label
            ...
            <input
              ...
              className="mt-2 p-2 w-full   bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200"
            />
            </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block font-bold " htmlFor="dateOfBirth">
              Date of Birth
            </label>
            <input
              id="dateOfBirth"
        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block font-bold  " htmlFor="homeAddress">
              Home Address
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block font-bold  " htmlFor="hhNumber">
              HH Number
            </label>
            <input
              id="hhNumber"
              ...
              type="text"
              required
              className={`mt-2 p-2 w-full   bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200 ${hhNumberError && "border-red-500"}`}
          ...
          <div className="space-x-4 md:col-span-2 flex justify-center mt-6">
            <button
              ...
              className="px-5 py-2.5 bg-teal-500 text-white text-lg rounded-lg cursor-pointer transition-colors duration-300 ease-in-out hover:bg-gray-600 disabled:bg-gray-500 disabled:cursor-not-allowed w-full md:w-auto"
            >
              Register
            </button>
            <button
