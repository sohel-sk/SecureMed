...
const ViewProfile = () => {
  ...
  return (
    ...
    <div className="bg-gray-100 p-4 sm:p-10 font-mono text-gray-900 flex flex-col justify-center items-center">
        <div className="h-full max-w-8xl bg-gray-100 p-24 rounded-lg shadow-lg flex flex-col justify-center items-center">
