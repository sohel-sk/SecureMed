...
const DoctorRegistry = () => {
  ...
  return (
    <div>
    <NavBar></NavBar>
    <div className="createehr min-h-screen flex items-center justify-center p-4 bg-gray-100 font-mono text-gray-900">
      <div className="w-full max-w-2xl">
        <h2 className="text-3xl mb-6 font-bold text-center">
          Doctor Registration
        </h2>
        <form className="bg-gray-100 p-6 rounded-lg shadow-lg grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="mb-4">
            <label
            ...
            <input
              ...
              type="text"
              required
              className="mt-2 p-2 w-full text-white bg-gray-100 border border-gray-600 rounded-md hover:bg-gray-200 transition duration-200"
          ...
          <div className="mb-4">
            <label className="block font-bold  " htmlFor="doctorName">
              Full Name
            </label>
            <input
              id="doctorName"
